---
title: 反射
url: /docs/notes/d-205f3859abe469be/d-f7ccae636d10bb41/n-b79d65cb92567a70/
draft: false
showDate: false
...
showEdit: false
obsidianSource: 面试/golang/反射.md
---

反射就是程序在运行时能够检测自身和修改自身的一种能力。
### 用途 {#h-db1ea9f1cf41c34a}
json 序列化和反序列化
ORM 
配置文件解析yaml，ini
### reflect {#h-4e18e0a6bde9193a}
#### reflect.TypeOf() {#h-8bc15bb51d514e0c}
```go
...
#### reflect.ValueOf() {#h-a8a9228c8c00f8e0}
```go
