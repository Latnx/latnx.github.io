---
title: 07 场景题
url: /docs/notes/d-205f3859abe469be/d-01bd224b3773410f/d-7cf3b59b7dee5a40/n-5506ab4555e98ff9/
draft: false
showDate: false
...
showEdit: false
obsidianSource: 面试/数据库/Redis/07 场景题.md
---

## 分布式锁 {#h-7b2f1ee28ec6b11a}
...
5. RedLock
## 消息队列 {#h-2bd0b34e7e1953fc}
![Pasted image 20260517185753.png](/obsidian/f5e7c57e52214854/Pasted%20image%2020260517185753.png)
...
## 秒杀 {#h-77c92eff86b69257}

  
第一点 **高并发**：海量请求，服务要能扛住。
我们可以先将库存名额预加载到Redis，然后在Redis中进行扣减，扣减成功的再通过消息队列，传递到MySQL做真正的订单生成。

<img src="/obsidian/8a6cb27d1f273775/Pasted%20image%2020260517191713.png" alt="Pasted image 20260517191713.png" width="322" loading="lazy" style="max-width:100%;height:auto">
